...
const authenticate = (req, res, next) => {
  ...
  try {
    // ENFORCE EXPIRATION: Remove ignoreExpiration to properly check token validity
    ...
    // SANITIZE EXPORTED ERRORS: Do not leak key mismatch/secret details to the client
...
const authorizeAdminOnlyLegacy = (req, res, next) => {
  ...
  // ADMIN AUTHENTICATION CHECK: Restored the commented role check to prevent privilege bypass
